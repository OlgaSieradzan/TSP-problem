...
W przypadku danych TSP_48 czasy są tutaj dość zbliżone. Najniższy z nich to 117.375 s. Natomiast dla TSP_76 mamy dwie wartości znacząco odstające od pozostałych. Dla TSP_127 czasy są zdecydowanie najdłuższe w stosunku do pozostałych. Nie ma tam tak rozbieżnych wyników jak dla TSP_76. 

## Statystyki

W statystykach poniżej przedstawiono najmniejszą oraz największą długość ścieżki uzyskaną przez Solver. Mamy również wyciągniętą średnią ze wszystkich wyników.
